...
public class Selfhelp {
  ...
  String[] selfBooks = {"Drawing From the Left Side of the Brain", "Grit", "The 7-Habits of a Highly Effective Teen"};
  ...
  public String sMedia() {
    ...
    return selfSelection(statement);
  }

  public String selfSelection(String statement) {
    String response = "";
...
//--------------------Books-----------------------
  public String sBookSelection() {
    Random r = new Random();
    selection = selfBooks[r.nextInt(selfBooks.length)];
    return selection;
  }
