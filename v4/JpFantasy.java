...
public class JpFantasy {

  Scanner in = new Scanner (System.in);
  String selection = "";

  //String arrays for different types of medias:
  String[] fantasyWebtoon = {"Spy x Family", "Bokura Wa Baray No Ko", "Shugo Chara", "I Want to be a Receptionalist of the Magic World", "Movies Are Real"};
  String[] fantasyAnime = {"Hunter x Hunter", "Demon Slayer"};
  String[] fantasyMovie = {"Weathering With You", "Spirited Away", "Your Name"};
  ...
  public String fMedia() {
    ...
    String f = "\n\t- 'Anime' \n\t\t>press 'anime' to claim a random anime~";
  ...
  public String fantasySelection(String statement) {
    ...
    if ((statement.trim()).length() == 0){
      ...
      System.out.println("\n-~-~-");
      System.out.println("Drumroll please... \nAnd your selection is: " + fAnimeSelection());
      System.out.println("Enjoy your read!!");
    }
...
//----------------Movie---------------------------
  public String fMovieSelection() {
      Random r = new Random();
      selection = fantasyMovie[r.nextInt(fantasyMovie.length)];
      return selection;
    }

//----------------Movie---------------------------
  public String fAnimeSelection() {
      Random r = new Random();
      selection = fantasyAnime[r.nextInt(fantasyAnime.length)];
      return selection;
    }
