...
public class Thriller {
  ...
  String[] thrillerBooks = {"Sherlock Holmes", "And Then There Were None"};
  String[] thrillerMovies = {"Knives Out"};
  String[] thrillerShows = {"Sherlock Holmes"};
  String[] thrillerGames = {"At Dead of Night", "Omori", "Resident Evil series"};
  ...
  public String thrillerSelection(String statement) {
    ...
    if ((statement.trim()).length() == 0){
      ...
      System.out.println("\n-~-~-");
      System.out.println("Drumroll please... \nAnd your selection is: " + tBookSelection());
      ...
      System.out.println("\n-~-~-");
      System.out.println("Drumroll please... \nAnd your selection is: " + tShowSelection());
      System.out.println("Enjoy your watch!!");
    }
      ...
      System.out.println("\n-~-~-");
      System.out.println("Drumroll please... \nAnd your selection is: " + tGameSelection());
...
//--------------------Books-----------------------
  public String tBookSelection() {
    Random r = new Random();
    selection = thrillerBooks[r.nextInt(thrillerBooks.length)];
    return selection;
  }
...
//--------------------Show-----------------------
  public String tShowSelection() {
    Random r = new Random();
    selection = thrillerShows[r.nextInt(thrillerShows.length)];
    return selection;
  }

//--------------------Show-----------------------
  public String tGameSelection() {
    Random r = new Random();
    selection = thrillerGames[r.nextInt(thrillerGames.length)];
    return selection;
  }
