...
public class CnHistorical {

  Scanner in = new Scanner (System.in);
  String selection = "";

  //String arrays for different types of medias:
  String[] historicalBooks = {"Qiang Jin Jiu: Invitation to Wine by Tang Qiuqing", "The Longest Night in Chang'an"};
  String[] historicalMovies = {"Farewell, My Concubine"};
  String[] historicalShows = {"The Longest Night in Chang'an", "Nirvana in Fire"};
  String[] historicalAD = {"Qiang Jin Jiu: Invitation to Wine"};
  ...
  public String historicalSelection(String statement) {
    ...
    if ((statement.trim()).length() == 0){
      ...
      System.out.println("\n-~-~-");
      System.out.println("Drumroll please... \nAnd your selection is: " + hADSelection());
      System.out.println("Enjoy your watch!!");
    }
    else
    {
...
//----------------AD---------------------------
  public String hADSelection() {
      Random r = new Random();
      selection = historicalAD[r.nextInt(historicalAD.length)];
      return selection;
    }
