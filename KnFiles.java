...
public class KnFiles{
  ...
  public String knGenres() {
    ...
    return genreKn(statement);
  }

  public String genreKn(String statement) {
    String response = "";
    if ((statement.trim()).length() == 0){
      ...
      System.out.println("\n-~-~-");
      KnHistorical med1 = new KnHistorical();
      med1.hMedia();
    }
      ...
      System.out.println("\n-~-~-");
      KnThriller med2 = new KnThriller();
      med2.tMedia();
    }
